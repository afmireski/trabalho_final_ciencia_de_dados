...
- [x] Exportação/Importação do dataset final usando parquet
    - [ ] Posso exportar as estações e históricos em parquet também.
- [ ] Consultas SQL
- [ ] Análise
...
- [x] Baseline
    ...
    - [ ] Mover para depois do pré-processamento
    - [ ] Escolher +1 algoritmo, provavelmente vai ser SVM se não demorar demais.
